							...
							if (this.userPublic.voice == "espeak" || espeaktts) {
                                ...
                                */
                                if (this.userPublic.voice == "broken") {
									...
									var voice2;
                                    this.userPublic.a = new Audio("https://mespeak-js-server-2.onrender.com/voiceforge?text=" + encodeURIComponent(say) + "&voice="+ encodeURIComponent(replaceAll(this.userPublic.voice,"voiceforge:","")));
                                    this.userPublic.a.play();
                                    this.userPublic.a.onended = function() {
                                        self.clearDialog()
                                    }
    ...
    $(document).ready(function () {
        window.BonziHandler = new (function () {
            return (
                (this.framerate = 1 / 15),
                (this.spriteSheets = {}),
				(this.sprites = ["black","grey","white","ghost","blue","boney","cyan","brown","green","lime","magenta","purple","red","orange","yellow","pink","pope","allifek","andrew","andrewgod","andrewpope","announcer","apple","baseball","blocky","book","bow","bubble","clippy","coiny","courtney","daffy","djordje","doctormike","earl","eraser","f1","firey","flower","fuckune","gelatin","genie","genius","gleb_korablev","golden_bonzi","golfball","granddad","granddadpope","homer","homestar","icecube","kairu","klasky1","knife","konnor88","leafy","lightbulb","links","luigi","mamachan","mario","marshmallow","match","matt","max","maxmac","mephone4","mem","merlin","needle","nickel","noob_pope","ofek","officelogo","oj","paintbrush","paper","peach","peedy","pen","pencil","pepper","pickle","pin","pm","qmark","robby","roblox_noob","rosalina","ruby","salt","seamus","snowball","spongy","steve","suitcase","taco","tennisball","testtube","timothy","toad","toadette","unbojih","unbojihface","unbojihhackerman","victor","vvx","white","yellow"]),
		...
		selector: "#themes_icon",
			items: {
				...
				bonziverse: { name: "BonziVERSE", callback: function () { theme('#content{background-color:black;background:url("./img/desktop/__Themes/BonziVERSE/logo-verse.png"), url("./img/desktop/__Themes/BonziVERSE/bonzi-verse.png"), url("./img/desktop/__Themes/BonziVERSE/wallpaper-verse.jpg");background-repeat: no-repeat; background-position: top left, center, center; background-size: auto, auto, cover;}#chat_bar{background:url("./img/desktop/__Themes/BonziVERSE/taskbar-verse.png")}#chat_tray{display:none}#chat_send{background:url("./img/desktop/__Themes/BonziVERSE/start-verse.png")') } },
                                synthwave: { name: "Synthwave", callback: function () { theme('#chat_log{margin-bottom:28px!important}#content{background-color:black;background:url("./img/desktop/__Themes/Synthwave/logo-synthwave.png"), url("./img/desktop/__Themes/Synthwave/bonzi-synthwave.png"), url("./img/desktop/__Themes/Synthwave/synthwave.gif");background-repeat: no-repeat; background-position: top left, center, center; background-size: auto, auto, cover;}#chat_bar{height:28px !important;background:url("./img/desktop/__Themes/Synthwave/taskbar-synthwave.png")}#chat_tray{background-image:url("./img/desktop/__Themes/Synthwave/notif_left-synthwave.png"),url("./img/desktop/__Themes/Synthwave/notif_right-synthwave.png"),url("./img/desktop/__Themes/Synthwave/notif-synthwave.png");background-repeat:no-repeat;background-position:left,right,left;background-size:5px 28px,3px 28px,100% 100%;vertical-align:middle;padding-left:7px;padding-top:3px;width:22px}#btn_tile{background-image:url("./img/desktop/__Themes/Synthwave/tile-synthwave.png")}#chat_send{width:58px;background-image:url("./img/desktop/__Themes/Synthwave/start-synthwave.png");background-size:100%;background-repeat:no-repeat;box-sizing:border-box;color:#000;font-family:"MS Sans Serif",Tahoma,sans-serif;font-style:normal;font-weight:700;letter-spacing:1px;font-size:11px;text-shadow:none;padding-left:21px;text-transform:capitalize}#chat_send:hover{background-position:0 -28px !important}#chat_send:active{background-position:0 -56px !important}'); var vaporwave_98 = new Audio("./sfx/vaporwave.wav"); vaporwave_98.play() } },
